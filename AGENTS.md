...
| Docs stay in sync with code | `make reconcile` (`framework/scripts/reconcile/`) reports doc↔code drift from recorded hashes; non-blocking until the judge is trusted, then a PR check (framework/docs/adr/0003) |
