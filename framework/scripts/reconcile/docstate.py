"""`.docstate` lockfile: recorded (blessed) hashes + verdict per binding.
...
collide (framework/docs/specs/reconcile.md, M2 schema follow-up). Human-diffable,
...
def classify(doc_changed: bool, code_changed: bool) -> VerdictKind:
    """The 3-way state from recorded vs actual (framework/docs/specs/reconcile.md)."""
