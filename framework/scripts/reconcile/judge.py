"""The LLM-judge frontier seam (framework/docs/adr/0003, Tier 3).
...
`AnthropicJudge` lazy-imports its client so the subpackage imports with no
...
class Generator(Protocol):
    """The safe-direction prose seam (framework/docs/adr/0003, M3). Returns fresh
