...
any harness (docs/adr/0001). The pipeline connecting them is
...
nothing (same pattern as AGENTS.md, docs/adr/0001).

- **Claude Code**: a shim subagent in `.claude/agents/<name>.md` whose body
  says "read `roles/<name>.md` and follow it"; its `tools:` frontmatter
