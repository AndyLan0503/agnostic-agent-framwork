...
description: The knowledge corpus conforms to OKF; knowledge/README.md is the format authority and field-mapping contract.
...
reconcile:
  ...
  bindings:
    - doc_anchor: knowledge-cards-follow-okf
      governs: knowledge/README.md
---

The `knowledge/` cards conform to OKF (Open Knowledge Format, published
...
`knowledge/README.md`, not an ADR. `sources` is a repo extension, not OKF's
